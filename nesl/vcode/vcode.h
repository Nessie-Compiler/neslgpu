...
extern char fused_library_name[];
...
typedef enum CVL_DESC_T {
    Elwise0, Elwise1, Elwise2, Elwise3, Elwise4, Elwise5, Elwise6,
    Elwise7, Elwise8, Elwise9,
    Elwise10, Elwise11, Elwise12, Elwise13, Elwise14, Elwise15, Elwise16,
    Elwise17, Elwise18, Elwise19,
    Elwise20, Elwise21, Elwise22, Elwise23, Elwise24, Elwise25, Elwise26,
    Elwise27, Elwise28, Elwise29,
    Elwise30, Elwise31, Elwise32, Elwise33, Elwise34, Elwise35, Elwise36,
    Elwise37, Elwise38, Elwise39,
    Elwise40,
    Scan, Reduce,  Special, SegOp,
...
extern vopdes_t *vopdes_fusion_table;
...
extern cvl_triple_t *cvl_fused_fun_list;

extern void load_fused_library PROTO_(());

/* this should be the token for PLUS */
#define vop_min PLUS
#define vop_fused_min FUSED
#define vop_table_look(vop) ( vopdes_table + ( (vop) - vop_min))
#define vop_fused_table_look(num) (&vopdes_fusion_table[(num)])
...
#define cvl_funct(vop, type)					\
    ...
    :    type == Int   ? cvl_fused_fun_list[vop- vop_fused_min].cvl_int.function          \
         : type == Float ? cvl_fused_fun_list[vop- vop_fused_min].cvl_float.function \
         :                 cvl_fused_fun_list[vop- vop_fused_min].cvl_boolean.function )
...
#define scratch_cvl_funct(vop, type)				\
    ...
    :    type == Int   ? cvl_fused_fun_list[vop- vop_fused_min].cvl_int.scratch_function          \
         : type == Float ? cvl_fused_fun_list[vop- vop_fused_min].cvl_float.scratch_function \
         :                 cvl_fused_fun_list[vop- vop_fused_min].cvl_boolean.scratch_function )
...
#define inplace_cvl_funct(vop, type)				\
    ...
    :    type == Int   ? cvl_fused_fun_list[vop- vop_fused_min].cvl_int.inplace_function          \
         : type == Float ? cvl_fused_fun_list[vop- vop_fused_min].cvl_float.inplace_function \
         :                 cvl_fused_fun_list[vop- vop_fused_min].cvl_boolean.inplace_function )
