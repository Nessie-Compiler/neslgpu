...
def main(n=1000000):
    ...
    def test_sort(S, n=1000000, trials=1, bits=8):
        npass, nfail = 0,0
        name = S.__name__
    ...
    print "---- Checking Python implementations (n=1000000) ----"
    # with places.here:
    #     test_sort(radix_sort8,    n=1000000)
   

    print "---- Checking GPU results (n=1000000) ----"
    with places.gpu0:
        test_sort(radix_sort8,    n=1000000)
